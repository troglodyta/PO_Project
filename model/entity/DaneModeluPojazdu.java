...
public class DaneModeluPojazdu extends Entity {
	...
	public String toString() {
		return "DaneModeluPojazdu [ID=" + ID + ", marka=" + marka + ", model="
				...
				+ pojemnoscSilnika + ", srednieSpalanie=" + srednieSpalanie
				+ ", wyposarzenie=" + wyposarzenie + ", moc=" + moc
				+ ", liczbaDrzwi=" + liczbaDrzwi + ", liczbaMiejsc="
				+ pojemnoscBagaznika
				+ ", cenaWypozyczenia=" + cenaWypozyczenia + ", kaucja="
